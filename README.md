...
<table>
  <tr>
    <td width="50%"><img src="./uploads/screenshot-1.png" width="100%"/></td>
    <td width="50%"><img src="./uploads/screenshot-2.png" width="100%"/></td>
  </tr>
  <tr>
    <td width="50%"><img src="./uploads/screenshot-3.png" width="100%"/></td>
    <td width="50%"><img src="./uploads/screenshot-4.png" width="100%"/></td>
  </tr>
</table>
...
1. 打开 [Releases](https://github.com/fireflyrqh/spatia-launcher/releases) 页面，下载最新 `.dmg`，或直接 [⬇️ 点击下载 v1.0.0](https://github.com/fireflyrqh/spatia-launcher/releases/download/macos/SpatiaLauncher-v1.0.0.dmg)
...
```bash
git clone https://github.com/fireflyrqh/spatia-launcher.git
cd spatia-launcher
...
- 🐛 提交 Bug：[GitHub Issues](https://github.com/fireflyrqh/spatia-launcher/issues)
- ✨ 功能建议：[GitHub Discussions](https://github.com/fireflyrqh/spatia-launcher/discussions)
...
- Issues：[GitHub Issues](https://github.com/fireflyrqh/spatia-launcher/issues)
...
1. Download the latest `.dmg` from [Releases](https://github.com/fireflyrqh/spatia-launcher/releases), or [⬇️ Direct Download v1.0.0](https://github.com/fireflyrqh/spatia-launcher/releases/download/macos/SpatiaLauncher-v1.0.0.dmg)
...
- 🐛 Bug reports: [GitHub Issues](https://github.com/fireflyrqh/spatia-launcher/issues)
- ✨ Feature requests: [GitHub Discussions](https://github.com/fireflyrqh/spatia-launcher/discussions)
